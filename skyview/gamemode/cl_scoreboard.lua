...
local PLAYER_LINE = {
	...
	Think = function( self )
		...
		if ( self.NumKills == nil || self.NumKills != self.Player:GetNWInt( "sky_score" ) ) then
			self.NumKills = self.Player:GetNWInt( "sky_score" )
	...
	Paint = function( self, w, h )
		...
		local col = self.Player:GetPlayerColor()
			col = Color( col.x * 255, col.y * 255, col.z * 255, 255 )
